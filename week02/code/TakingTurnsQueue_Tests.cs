...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Assert.AreEqual failed. Expected:<Bob>. Real:<Sue>
    ...
    // Defect(s) Found: Assert.AreEqual failed. Expected:<Tim>. Real:<Sue>.
    ...
    // Defect(s) Found: Not found defect: Aproved TestTakingTurnsQueue_Empty [< 1 ms] 
