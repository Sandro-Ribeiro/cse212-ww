...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Assert.AreEqual falhou. Esperado:<Bob>. Real:<Sue>
    ...
    // Defect(s) Found: Assert.AreEqual falhou. Esperado:<Tim>. Real:<Sue>.
    ...
    // Defect(s) Found: Not found defect: Aprovado TestTakingTurnsQueue_Empty [< 1 ms] 
